...
class CurrencyModeView: UIView {
    ...
    private lazy var firstItem: CurrencyExtendedModeView = {
        var view = CurrencyExtendedModeView()
    ...
    private lazy var secondItem: CurrencyPlainModeView = {
        var view = CurrencyPlainModeView()
